...
describe("date problem", function () {
  it("gapAnalysis should return an array", function () {
    const list = [
      [3, 5],
      [6, 8],
    ];
  ...
  it("rangeMaker should return an array of all numbers between min and max", function () {
    const min = 1;
    const max = 3;
  ...
  it("rangeMaker should return an array of a single value when give that as a range", function () {
    const min = 1;
    const max = 1;
  ...
  it("gapAnalysis should return an array with the gaps from the given list", function () {
    const list = [
      [3, 5],
      [6, 8],
    ];
